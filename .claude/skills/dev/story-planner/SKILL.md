...
## Story Rules — Acceptance Criteria

כל AC חייב לעמוד ב-3 קריטריונים:
- **Testable** — ניתן לאמת ב-`pnpm test` או בדיקה ידנית ספציפית
- **Binary** — עבר / נכשל. לא "עובד בערך"
- **RED-capable** — ניתן לכתוב בדיקה שתיכשל לפני המימוש ותעבור אחריו

אם AC לא עומד בקריטריונים → חזור למשתמש עם ניסוח חלופי.
...
2. האם הסטורי הזה מתאים לשלב הנוכחי?
3. האם ה-backend API שהסטורי מסתמך עליו כבר קיים?
4. האם כל מה שהסקיל הזה דורש כבר קיים?
